...
ACTIVE_FEATURE_GROUPS = ["lexical", "punctuation", "function_words"]
...
# Replace the svm with linear_svc for a faster but slightly worse SVM baseline.
MODELS_TO_COMPARE = ["logistic_regression", "linear_svc", "mlp", "naive_bayes"]
